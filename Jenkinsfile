                ...
                script {
                    ...
                    if (params.TEST_FOLDER != 'All') {
                        ...
                        if (params.SPEC_FILE != 'All' && params.SPEC_FILE != 'No specs found') {
                            // If folder is tests/advanced and spec is canvas.spec.js, Playwright needs full path
                            // But since we appended folder above, Playwright will look inside that folder.
                            // Actually, best practice is to provide full path if specific file.
                            // Let's reset and build full path.
